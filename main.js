...
var _user$project$Main$theme = {
	primary: _rtfeldman$elm_css$Css$hex('42f4c2'),
	secondary: _rtfeldman$elm_css$Css$hex('c8d8c3')
};
var _user$project$Main$compass = function (orientation) {
	return A2(
						...
						_1: {
							...
							_1: {
								...
								_0: A3(
									...
									_user$project$Main$theme.primary),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$transform(
										_rtfeldman$elm_css$Css$rotate(
											_rtfeldman$elm_css$Css$deg(orientation.heading))),
									_1: {
										ctor: '::',
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'UpdateGeolocation':
				var _p4 = _p2._0.heading;
				var newPosition = A3(_user$project$Main$Position, _p2._0.latitude, _p2._0.longitude, _p4);
				var newRef = function () {
					var _p3 = _p4;
					if (_p3.ctor === 'Nothing') {
						return model.reference;
					} else {
						return model.orientation.alpha - _p3._0;
					}
				}();
				return {
					ctor: '_Tuple2',
	...
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			...
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					ctor: '::',
					_0: _user$project$Main$fontBase,
					_1: {
						ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$EnableGeolocation),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Watch geolocation'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _user$project$Main$compass(model.orientation),
							_1: {ctor: '[]'}
						}
					}
				}),
